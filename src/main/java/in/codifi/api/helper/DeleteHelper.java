...
//	CkycResponseRepos ckycResponseRepos;
	...
	public ResponseModel DeleteAll(ApplicationUserEntity applicationUserEntity) {
		...
		applicationUserEntity.setStage("1.1");
...
//		ckycResponseRepos.deleteByApplicationId(applicationUserEntity.getId());
		...
		responseModel.setResult("User Details deleted SuccessFully");
			...
			commonMethods.SaveLog(applicationUserEntity.getId(),"DeleteHelper","DeleteAll",e.getMessage());
			commonMethods.sendErrorMail("An error occurred while processing your request, In DeleteAll. for the Error: " + e.getMessage(),"ERR-001");
